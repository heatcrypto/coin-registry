...
export declare class ChainModel {
    ...
    confirmed: number;
    blockTime: number;
    constructor(id: number, name: string, addressTypes: Array<string>, network: string, assetTypes: Array<AssetTypeModel>, bip44: number, explorers: Array<ExplorerModel>, staticFee: string, bip21: string, confirmed: number, blockTime: number);
